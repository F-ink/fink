...
final class Version20210520100438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(80) DEFAULT NULL, firstname VARCHAR(80) DEFAULT NULL, pseudo VARCHAR(80) NOT NULL, tattoo_shop VARCHAR(100) DEFAULT NULL, city VARCHAR(100) DEFAULT NULL, address VARCHAR(100) DEFAULT NULL, profile_picture VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, instagram VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, siret VARCHAR(14) DEFAULT NULL, hide TINYINT(1) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1599687E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
